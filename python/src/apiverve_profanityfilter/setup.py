...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/profanityfilter',
        'Source': 'https://github.com/apiverve/profanityfilter-api',
        'Bug Tracker': 'https://github.com/apiverve/profanityfilter-api/issues'
    },
    classifiers=[
