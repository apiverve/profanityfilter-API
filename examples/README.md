# Profanity Filter API - Examples

This folder contains example code for using the Profanity Filter API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/profanityfilter',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/profanityfilter");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/profanityfilter](https://docs.apiverve.com/ref/profanityfilter)
